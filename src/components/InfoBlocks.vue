<template>
  <div class="info-blocks">
    <div class="info-blocks__item js-img" data-src="/img/info-item-bg1.jpg">
      <div class="wrapper">
        <div class="info-blocks__item-img">
          <img
            data-src="/img/info-item-img1.jpg"
        ...
        <div class="info-blocks__item-text">
          ...
          <span class="info-blocks__item-descr"
    ...
    <div
      class="info-blocks__item info-blocks__item-reverse js-img"
      data-src="/img/info-item-bg2.jpg"
    >
      <div class="wrapper">
        <div class="info-blocks__item-img">
          <img
            data-src="/img/info-item-img2.jpg"
            src="data:image/gif;base64,R0lGODlhAQABAAAAACw="
            class="js-img"
            alt=""
          />
        ...
        <div class="info-blocks__item-text">
          ...
          <a href="https://www.youtube.com" class="info-blocks__item-link">
