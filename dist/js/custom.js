$(window).on("load", function () {
  ...
  if ($(window).width() < 767) {
    ...
    setTimeout(function () {
      ...
      $("head").append(
        '<link href="https://fonts.googleapis.com/css2?family=Lato:wght@400;700&family=Montserrat:wght@700&family=Mrs+Saint+Delafield&family=Tenor+Sans&display=swap" rel="stylesheet">'
      );
    }, 1300);
  } else {
    setTimeout(function () {
...
$(function () {
  ...
  if ($("input[type='tel']").length) {
    $("input[type='tel']").mask("+27 (999) 999-9999");
  }
  /* phone mask */
  ...
  $(".js-products-items").slick({
    dots: false,
    prevArrow:
      '<button id="prev" type="button" class="slick-arrow slick-prev"><i class="icon icon-arrow"></i></button>',
    nextArrow:
      '<button id="next" type="button" class="slick-arrow slick-next"><i class="icon icon-arrow"></i></button>',
    speed: 300,
    slidesToShow: 4,
    slidesToScroll: 1,
    infinite: false,
  ...
  $(".profile-orders__col-btn").on("click", function () {
    ...
    $(this)
      .parents(".profile-orders__item")
      .siblings(".profile-orders__item")
      .removeClass("active");
  });
  /* profile order toggle */
